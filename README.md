...
Click on the project names or badges below to access each individual project repository.
...
These repositories contain my personal solutions to 42 School projects, each one following my own style, always trying to create a efficient and easy to understand code, but are not neccessary the 100% optimal way to do it.

The goal of making this public is to help others compare, learn and improve — not to encourage blind copying.

Please take the time to understand the concepts, write your own code and treat these solutions as a reference, not a shortcut.
